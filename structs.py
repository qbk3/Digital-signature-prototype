...
class Key(PrettySequence):
    componentType = namedtype.NamedTypes(
        namedtype.NamedType('open_key', OpenKey()),
        namedtype.NamedType('priv_key', univ.Integer()),
        namedtype.NamedType('name', UTF8String()),
        # p, q, a, b, x, y
        namedtype.NamedType('p', UTF8String()),
        namedtype.NamedType('q', UTF8String()),
        namedtype.NamedType('a', UTF8String()),
        namedtype.NamedType('b', UTF8String()),
        namedtype.NamedType('xp', UTF8String()),
        namedtype.NamedType('yp', UTF8String())
    )
